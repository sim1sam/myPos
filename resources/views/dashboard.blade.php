...
@section('page-content')
    <section class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <a href="{{ route('pos.stock') }}" class="pos-dashboard-card group">
            ...
            <h2 class="mt-2 text-lg font-semibold text-slate-800">Inventory</h2>
            <p class="mt-1 text-sm text-slate-500">Opening stock, purchases, sales, and damage</p>
        </a>
